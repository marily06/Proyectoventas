...
window.deleteItemDt = function (data) {
  var id = $(data).data('id');
  Swal.fire({
    title: '¿Estás seguro?',
...
window.errorToList = function (errors) {
...
window.notifyErrorApi = function (e) {
